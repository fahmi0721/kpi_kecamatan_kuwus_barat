...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h5 class="mb-2">Data Jabatan</h5></div>
        <div class="col-sm-6">
        ...
        <div class="col-12">
            <div class="card card-primary card-outline mb-4">
                <div class="card-header d-flex  align-items-center">
                    ...
                    <a href="{{ route('jabatan.create') }}" class="btn btn-primary btn-sm ms-auto">
...
function hapusData(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "{{ route('jabatan.delete', ':id') }}".replace(':id', id),
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    _method: "DELETE"
